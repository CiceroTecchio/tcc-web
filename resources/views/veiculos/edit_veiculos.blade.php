...
<div class="ui raised very padded container segment mt-5">
    ...
    <form class="ui form" action="{{ route('veiculos.update', $veiculo->id) }}" method="POST">
        @csrf
        @method('PUT')

        <div class="field">
            <label>Nome Identificador</label>
            <input type="text" name="identificador" value="{{$veiculo->identificador}}" placeholder="Identificação do Veículo...">
        </div>
        ...
        <div class="field">
            <div class="ui slider checkbox">
                <input type="checkbox" @if($veiculo->fg_ativo == true) checked="checked" @endif text name="fg_ativo">
...
<script>
    $(document).ready(function() {
        ...
        $('.ui.dropdown').dropdown('set selected', <?php echo $veiculo->cod_marca ?>);
        $('.ui.form').form({
            inline: true,
            on: 'blur',
            fields: {

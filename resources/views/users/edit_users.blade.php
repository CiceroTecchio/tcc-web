...
<div class="ui raised very padded container segment mt-5">
    ...
    <form class="ui form" action="{{ route('colaboradores.update', $usuario->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="two fields">
            <div class="field">
                <label>Nome</label>
                <input type="text" name="name" value="{{$usuario->name}}" placeholder="Nome do Colaborador..." autocomplete="false">
            </div>
            <div class="field">
                <label>CPF</label>
                <input id="cpf" type="text" value="{{$usuario->cpf}}" name="cpf" placeholder="Número do CPF..." autocomplete="false">
            </div>
        </div>
        <div class="two fields">
            <div class="field">
                <label>E-Mail</label>
                <input type="text" value="{{$usuario->email}}" name="email" placeholder="Endereço de E-Mail..." autocomplete="false">
            </div>
            <div class="field">
                <label>Senha</label>
        ...
        <div class="two fields">
            <div class="field">
                <div class="ui slider checkbox">
                    <input type="checkbox" @if($usuario->fg_ativo == true) checked="checked" @endif name="fg_ativo">
                    <label>Ativo</label>
                </div>
            </div>
            <div class="field">
                <div class="ui toggle checkbox">
                    <input type="checkbox" @if($usuario->fg_admin == true) checked="checked" @endif name="fg_admin">
